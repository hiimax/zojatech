...
class TpDimension {
  ...
  TpDimension(BuildContext context) {
...
class TpFontSizer {
  ...
  TpFontSizer(BuildContext context) {
...
class SizeConfig {
  ...
  static TpFontSizer? fontSizer;
  static TpDimension? sizer;

  static void init(BuildContext context) {
    _instance ??= SizeConfig._();
    fontSizer = TpFontSizer(context);
    sizer = TpDimension(context);
  }
...
class TpScaleUtil {
  ...
  TpDimension get sizer => TpDimension(context);

  TpFontSizer get fontSizer => TpFontSizer(context);

  TpInsets get insets => TpInsets(context);
}
